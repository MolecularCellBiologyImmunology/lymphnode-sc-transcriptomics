...
sc <- clustexp(sc,clustnr=30,bootnr=100,metric="pearson",do.gap=FALSE,sat=TRUE,SE.method="Tibs2001SEmax",SE.factor=.25,B.gap=50,cln=0,rseed=17000,FUNcluster="kmedoids",FSelect=TRUE)
# compute t-SNE map
...
plotsymbolstsne(sc,types=sub("(\\_\\d+)$", weeks, names(sc@ndata)))
