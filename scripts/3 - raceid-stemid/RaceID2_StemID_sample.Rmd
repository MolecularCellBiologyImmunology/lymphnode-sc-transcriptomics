...
## input data
x <- read.csv("D:/Userdata/jj.koning/MIKE/seperatescripts v3/data/3 - combinedcounts/normalized_counts.csv",sep=",",header=TRUE)
rownames(x) <- x$GENEID
...
changewd("D:/Userdata/jj.koning/MIKE/seperatescripts v3/data/4 - raceidstemid/All")
