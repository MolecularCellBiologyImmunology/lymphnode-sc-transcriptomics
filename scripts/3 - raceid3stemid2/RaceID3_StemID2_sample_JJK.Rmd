...
params: # DO NOT CHANGE
  scriptdirectory: "D:/Userdata/jj.koning/MIKE/Seperate Scripts/scripts/3 - raceid3stemid2"
  inputdata:  "D:/Userdata/jj.koning/MIKE/Seperate Scripts/data/3 - combinedcounts/LNS_W2_unfiltered_combined.csv"
  outputdirectory: "D:/Userdata/jj.koning/MIKE/Seperate Scripts/data/4 - raceidstemid/Update_Unfiltered/190430_wk2/RaceID3StemdID2"
...
source(paste(params$scriptdirectory, "RaceID3_StemID2_class.R", sep = "/"))
...
sc <- filterdata(sc, params$mintotal, params$minexpr, params$minnumber, params$maxexpr, params$downsample, params$sfn, params$hkn, params$dsn, params$rseed, params$CGenes, params$FGenes, params$ccor)
...
sc <- clustexp(sc,params$maxclustnr,params$bootnr,metric="pearson",do.gap=FALSE,sat=TRUE,SE.method="Tibs2001SEmax",SE.factor=.25,B.gap=50,cln=0,rseed=17000,FUNcluster="kmedoids",FSelect=TRUE)
# compute t-SNE map
...
plotsymbolstsne(sc,types=sub("(.*_.*\\.\\d+)$","Pilot (W2)",sub("(_P.*_.*\\.\\d+)$","", names(sc@ndata))))
...
setwd("D:/Userdata/jj.koning/MIKE/Seperate Scripts/data/4 - raceidstemid/Update_Unfiltered/190430_wk2/RaceID3StemdID2")
...
ltr <- projback(ltr,params$pdishuf,nmode=FALSE,fast=FALSE,rseed=17000)
