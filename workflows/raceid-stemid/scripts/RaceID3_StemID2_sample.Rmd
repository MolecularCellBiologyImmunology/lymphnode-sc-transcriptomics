...
## Remove Specific Cells from the Analysis (Object CellsToRemove has to be made during past-analysis, else this will be skipped)
if (exists("CellsToRemove")) {
  prdata <- lapply(CellsToRemove, function(x) {dplyr::select(prdata, -x)})
}
